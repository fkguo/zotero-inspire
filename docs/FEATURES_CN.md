...
- **共同导师开关**：顶部胶囊按钮可隐藏补充的共同导师，同时保留中心人物自己的导师和已展开的祖先学生分支。**查找 / 路径**：在已加载谱系中按姓名、INSPIRE ID 或单位查找并定位，不更换中心、不请求网络。选择两个人物可高亮最短师承连接路径并自动缩放到该路径；每段箭头保持原方向，也可展示经共同导师连接的路径。
- **分支菜单**：一次展开当前可见祖先的一代学生，遵守既有代数、人数和请求上限。可收起所选人物的学生分支、恢复单个分支或恢复全部分支，无需重复请求。共享学生若还有其他可见连接则保留；中心人物的祖先链不允许收起。定位隐藏人物或显示隐藏路径会恢复所需显示。
