...
pref("__prefsPrefix__.keep_preprint_type", true); // Keep Preprint/Report item type until INSPIRE reports a journal publication; unpublished arXiv journalArticle items become preprint again (ignored while arxiv_in_journal_abbrev is on)
...
pref("__prefsPrefix__.external_read_token", ""); // Read-only connector auth token (generated on first startup)
