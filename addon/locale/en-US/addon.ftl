...
references-panel-status-empty = Select an item to load references
references-panel-reader-mode = References are unavailable in the reader view
references-panel-select-item = Select a single regular item to view references
references-panel-no-recid = INSPIRE record not found for this item
references-panel-status-loading = Loading references...
references-panel-status-error = Failed to load references
references-panel-empty-list = No references available
references-panel-no-match = No references match current filter
references-panel-refresh = Refresh
references-panel-filter-placeholder = Filter references
...
references-panel-toast-add-first = Please add the reference to your library first
references-panel-toast-already-linked = Reference already linked
