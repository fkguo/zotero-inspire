...
academic-tree-expand-ancestors = Expand ancestors’ students (1 generation)
...
academic-tree-export-hint = SVG/PNG: canvas image; JSON/CSV: people and relationships in the selected scope. Full tree includes hidden branches, without fetching more data. SVG preserves detail in large trees.
