...
academic-tree-other = Other / unspecified
academic-tree-unknown = Unspecified
academic-tree-reload = Reload / retry
...
academic-tree-source-note = Source: public INSPIRE author records. Arrows run from advisor to student; dashed cards have no linked author ID. Missing records do not establish the absence of a relationship. Blue lines highlight relationships of the selected or hovered person.
