...
pref-pdf-native-overlay-reuse =
    .label = Reuse Zotero 10 citation analysis
pref-pdf-native-overlay-reuse-desc = Reuses completed Zotero 10 citation results in the background to make citation hover and lookup responsive. Applies only to source-audited Zotero 10.0 builds and takes effect after restart; other documents keep the ordinary matching path.
